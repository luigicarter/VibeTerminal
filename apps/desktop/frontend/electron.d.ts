...
declare global {
  interface Window {
    vibe?: {
      ...
      openCodexProviders?: import('./types').OpenCodexProvidersApi;
      modelProviders?: import('./types').ModelProvidersApi;
      claudeProviders?: {
      ...
      terminal: {
        ...
        showContextMenu: (payload: {
          ...
          imagePaste?: boolean; launchToken?: number;
        }) => Promise<boolean>;
        onContextMenuPaste: (
          callback: (payload: { id: string; text: string; launchToken?: number }) => void
        ) => () => void;
        onEvent: (callback: (event: TerminalEvent) => void) => () => void;
      };
      codexWeb: import('./codexWeb').CodexWebApi;
      fusionChat: {
      ...
      fusionModelCatalog?: {
        list: (payload: { family: string; refresh?: boolean }) => Promise<{
          ok: boolean;
          family: string;
          models:
            | {
