...
export function dashboardProvider(session: RelaySession): string {
  ...
  const labels: Record<string, string> = { terminal: "Shell", codex: "Codex", "open-codex": "Open Codex", claude: "Claude", cursor: "Cursor", gemini: "Gemini", opencode: "OpenCode", kimi: "Kimi", "kimi-custom": "Kimi Custom", qwen: "Qwen", grok: "Grok Build", fusion: "Fusion", openfusion: "Open Fusion", "claude-custom": "Open Claude Code" };
