...
export interface TerminalRuntimeSnapshot {
  ...
  children: Array<{ id: string; ownerConversationId?: string; label?: string; startedAt: number; observation?: "observed" | "provisional"; attention?: { id: string; state: "waiting"; reason?: string; updatedAt: number } }>;
