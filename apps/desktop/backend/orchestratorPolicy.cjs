...
const aliases = kind => { const value = String(kind || '').toLowerCase(); return value === 'open-codex' ? ['open-codex', 'open codex'] : value === 'openfusion' ? ['openfusion', 'open fusion'] : value === 'claude' ? ['claude', 'claude code'] : value === 'grok' ? ['grok', 'grok build'] : [value]; };
