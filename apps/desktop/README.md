...
| --- | --- | --- |
| Windows x64 | [LinaTerminal-Setup-0.1.123.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.123/LinaTerminal-Setup-0.1.123.exe) | Standard Windows installer. |
