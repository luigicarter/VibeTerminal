...
export const App = () => {
  ...
  useEffect(() => {
    ...
    document.querySelector('meta[name="description"]')?.setAttribute("content", isPricingPage ? "Compare Lina Terminal's Full Access and Orchestrator plans. Every terminal and agent mode in both, with voice and task coordination in Orchestrator. Pricing coming soon." : isVoicePage ? "Say Hey Lina. Use hands-free voice or push-to-talk to delegate tasks, inspect agents, and answer questions in Lina Terminal." : isOrchestratorPage ? "Talk to your workspace. Lina's Orchestrator routes tasks, inspects sessions, and connects your agents through voice and text." : isAgentsPage ? "Run coding agents side by side, pair planners with executors, and coordinate your local projects in Lina Terminal." : description);
