...
The current public Windows release is `v0.1.6`:

- Release page: `https://github.com/luigicarter/VibeTerminal/releases/tag/v0.1.6`
- Installer: `https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.6/vibeTerminal-Setup-0.1.6.exe`
