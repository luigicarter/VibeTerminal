...
The current public Windows release is `v0.1.69`:

- Release page: `https://github.com/luigicarter/VibeTerminal/releases/tag/v0.1.69`
- Installer: `https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.69/vibeTerminal-Setup-0.1.69.exe`
