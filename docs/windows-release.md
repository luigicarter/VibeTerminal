...
The current public Windows release is `v0.1.27`:

- Release page: `https://github.com/luigicarter/VibeTerminal/releases/tag/v0.1.27`
- Installer: `https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.27/vibeTerminal-Setup-0.1.27.exe`
