...
The current public Windows release is `v0.1.34`:

- Release page: `https://github.com/luigicarter/VibeTerminal/releases/tag/v0.1.34`
- Installer: `https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.34/vibeTerminal-Setup-0.1.34.exe`
