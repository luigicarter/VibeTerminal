...
function sessionSummary(s, { includeNavigationGuide = true } = {}) {
  ...
  return {
    ...
    kind: s.kind, provider: s.provider, cwd: s.cwd, projectName: s.projectName, projectId: s.projectId,
    visiblePane: s.visiblePane, board: s.board, inventoryRevision: s.inventoryRevision,
