...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.75.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.75/vibeTerminal-Setup-0.1.75.exe) | Standard Windows installer. |
