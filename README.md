...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.68.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.68/vibeTerminal-Setup-0.1.68.exe) | Standard Windows installer. |
