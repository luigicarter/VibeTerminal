...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.40.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.40/vibeTerminal-Setup-0.1.40.exe) | Standard Windows installer. |
