...
| --- | --- | --- |
| Windows x64 | [LinaTerminal-Setup-0.1.105.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.105/LinaTerminal-Setup-0.1.105.exe) | Standard Windows installer. |
