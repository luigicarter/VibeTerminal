...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.55.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.55/vibeTerminal-Setup-0.1.55.exe) | Standard Windows installer. |
