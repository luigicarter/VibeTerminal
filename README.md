...
| --- | --- | --- |
| Windows x64 | [LinaTerminal-Setup-0.1.109.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.109/LinaTerminal-Setup-0.1.109.exe) | Standard Windows installer. |
