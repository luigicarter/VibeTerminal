...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.77.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.77/vibeTerminal-Setup-0.1.77.exe) | Standard Windows installer. |
