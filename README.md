...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.39.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.39/vibeTerminal-Setup-0.1.39.exe) | Standard Windows installer. |
