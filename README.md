...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.52.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.52/vibeTerminal-Setup-0.1.52.exe) | Standard Windows installer. |
