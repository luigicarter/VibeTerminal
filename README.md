...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.27.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.27/vibeTerminal-Setup-0.1.27.exe) | Standard Windows installer. |
