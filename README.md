...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.59.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.59/vibeTerminal-Setup-0.1.59.exe) | Standard Windows installer. |
