...
| --- | --- | --- |
| Windows x64 | [LinaTerminal-Setup-0.1.113.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.113/LinaTerminal-Setup-0.1.113.exe) | Standard Windows installer. |
