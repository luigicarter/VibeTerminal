...
| --- | --- | --- |
| Windows x64 | [LinaTerminal-Setup-0.1.106.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.106/LinaTerminal-Setup-0.1.106.exe) | Standard Windows installer. |
