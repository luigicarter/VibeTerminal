...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.66.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.66/vibeTerminal-Setup-0.1.66.exe) | Standard Windows installer. |
