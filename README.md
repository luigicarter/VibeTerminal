...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.72.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.72/vibeTerminal-Setup-0.1.72.exe) | Standard Windows installer. |
