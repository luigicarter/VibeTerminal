...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.45.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.45/vibeTerminal-Setup-0.1.45.exe) | Standard Windows installer. |
