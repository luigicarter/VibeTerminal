...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.57.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.57/vibeTerminal-Setup-0.1.57.exe) | Standard Windows installer. |
