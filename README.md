...
| --- | --- | --- |
| Windows x64 | [LinaTerminal-Setup-0.1.107.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.107/LinaTerminal-Setup-0.1.107.exe) | Standard Windows installer. |
