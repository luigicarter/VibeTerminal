...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.38.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.38/vibeTerminal-Setup-0.1.38.exe) | Standard Windows installer. |
