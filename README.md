...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.96.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.96/vibeTerminal-Setup-0.1.96.exe) | Standard Windows installer. |
