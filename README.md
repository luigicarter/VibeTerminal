...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.91.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.91/vibeTerminal-Setup-0.1.91.exe) | Standard Windows installer. |
