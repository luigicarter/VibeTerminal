...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.63.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.63/vibeTerminal-Setup-0.1.63.exe) | Standard Windows installer. |
