...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.14.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.14/vibeTerminal-Setup-0.1.14.exe) | Standard Windows installer. |
