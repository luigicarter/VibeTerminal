...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.65.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.65/vibeTerminal-Setup-0.1.65.exe) | Standard Windows installer. |
