...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.60.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.60/vibeTerminal-Setup-0.1.60.exe) | Standard Windows installer. |
