...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.87.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.87/vibeTerminal-Setup-0.1.87.exe) | Standard Windows installer. |
