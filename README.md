...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.34.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.34/vibeTerminal-Setup-0.1.34.exe) | Standard Windows installer. |
