...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.71.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.71/vibeTerminal-Setup-0.1.71.exe) | Standard Windows installer. |
