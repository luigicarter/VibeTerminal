...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.32.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.32/vibeTerminal-Setup-0.1.32.exe) | Standard Windows installer. |
