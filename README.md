...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.51.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.51/vibeTerminal-Setup-0.1.51.exe) | Standard Windows installer. |
