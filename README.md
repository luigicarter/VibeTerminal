...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.89.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.89/vibeTerminal-Setup-0.1.89.exe) | Standard Windows installer. |
