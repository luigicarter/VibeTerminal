...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.15.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.15/vibeTerminal-Setup-0.1.15.exe) | Standard Windows installer. |
