...
| --- | --- | --- |
| Windows x64 | [LinaTerminal-Setup-0.1.110.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.110/LinaTerminal-Setup-0.1.110.exe) | Standard Windows installer. |
