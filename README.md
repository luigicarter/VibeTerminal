...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.31.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.31/vibeTerminal-Setup-0.1.31.exe) | Standard Windows installer. |
