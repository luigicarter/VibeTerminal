...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.3.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.3/vibeTerminal-Setup-0.1.3.exe) | Standard installer. Adds vibeTerminal to the Start Menu. |
