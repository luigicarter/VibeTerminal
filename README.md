...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.16.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.16/vibeTerminal-Setup-0.1.16.exe) | Standard Windows installer. |
