...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.50.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.50/vibeTerminal-Setup-0.1.50.exe) | Standard Windows installer. |
