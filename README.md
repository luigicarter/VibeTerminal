...
| --- | --- | --- |
| Windows x64 | [LinaTerminal-Setup-0.1.108.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.108/LinaTerminal-Setup-0.1.108.exe) | Standard Windows installer. |
