...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.44.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.44/vibeTerminal-Setup-0.1.44.exe) | Standard Windows installer. |
