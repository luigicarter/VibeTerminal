...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.35.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.35/vibeTerminal-Setup-0.1.35.exe) | Standard Windows installer. |
