...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.102.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.102/vibeTerminal-Setup-0.1.102.exe) | Standard Windows installer. |
