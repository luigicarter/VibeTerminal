...
| --- | --- | --- |
| Windows x64 | [LinaTerminal-Setup-0.1.111.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.111/LinaTerminal-Setup-0.1.111.exe) | Standard Windows installer. |
