...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.95.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.95/vibeTerminal-Setup-0.1.95.exe) | Standard Windows installer. |
