...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.37.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.37/vibeTerminal-Setup-0.1.37.exe) | Standard Windows installer. |
