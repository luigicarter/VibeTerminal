...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.43.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.43/vibeTerminal-Setup-0.1.43.exe) | Standard Windows installer. |
