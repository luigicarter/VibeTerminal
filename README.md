...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.74.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.74/vibeTerminal-Setup-0.1.74.exe) | Standard Windows installer. |
