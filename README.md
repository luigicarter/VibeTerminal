...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.54.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.54/vibeTerminal-Setup-0.1.54.exe) | Standard Windows installer. |
