...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.90.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.90/vibeTerminal-Setup-0.1.90.exe) | Standard Windows installer. |
