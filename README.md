...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.93.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.93/vibeTerminal-Setup-0.1.93.exe) | Standard Windows installer. |
