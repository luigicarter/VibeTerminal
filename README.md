...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.101.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.101/vibeTerminal-Setup-0.1.101.exe) | Standard Windows installer. |
