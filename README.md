...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.56.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.56/vibeTerminal-Setup-0.1.56.exe) | Standard Windows installer. |
