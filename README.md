...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.84.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.84/vibeTerminal-Setup-0.1.84.exe) | Standard Windows installer. |
