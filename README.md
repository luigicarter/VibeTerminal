...
| --- | --- | --- |
| Windows x64 | [LinaTerminal-Setup-0.1.125.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.125/LinaTerminal-Setup-0.1.125.exe) | Standard Windows installer. |
