...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.62.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.62/vibeTerminal-Setup-0.1.62.exe) | Standard Windows installer. |
