...
| --- | --- | --- |
| Windows x64 | [LinaTerminal-Setup-0.1.112.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.112/LinaTerminal-Setup-0.1.112.exe) | Standard Windows installer. |
