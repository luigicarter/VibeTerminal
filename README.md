...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.83.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.83/vibeTerminal-Setup-0.1.83.exe) | Standard Windows installer. |
