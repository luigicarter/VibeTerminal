...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.64.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.64/vibeTerminal-Setup-0.1.64.exe) | Standard Windows installer. |
