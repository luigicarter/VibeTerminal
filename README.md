...
| --- | --- | --- |
| Windows x64 | [LinaTerminal-Setup-0.1.127.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.127/LinaTerminal-Setup-0.1.127.exe) | Standard Windows installer. |
