...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.58.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.58/vibeTerminal-Setup-0.1.58.exe) | Standard Windows installer. |
