...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.88.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.88/vibeTerminal-Setup-0.1.88.exe) | Standard Windows installer. |
