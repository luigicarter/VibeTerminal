...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.33.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.33/vibeTerminal-Setup-0.1.33.exe) | Standard Windows installer. |
