...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.98.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.98/vibeTerminal-Setup-0.1.98.exe) | Standard Windows installer. |
