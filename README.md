...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.67.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.67/vibeTerminal-Setup-0.1.67.exe) | Standard Windows installer. |
