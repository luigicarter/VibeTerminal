...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.92.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.92/vibeTerminal-Setup-0.1.92.exe) | Standard Windows installer. |
