...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.94.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.94/vibeTerminal-Setup-0.1.94.exe) | Standard Windows installer. |
