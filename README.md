...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.42.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.42/vibeTerminal-Setup-0.1.42.exe) | Standard Windows installer. |
