...
| --- | --- | --- |
| Windows x64 | [LinaTerminal-Setup-0.1.114.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.114/LinaTerminal-Setup-0.1.114.exe) | Standard Windows installer. |
