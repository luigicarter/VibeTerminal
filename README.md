...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.21.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.21/vibeTerminal-Setup-0.1.21.exe) | Standard Windows installer. |
