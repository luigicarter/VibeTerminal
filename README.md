...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.36.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.36/vibeTerminal-Setup-0.1.36.exe) | Standard Windows installer. |
