...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.7.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.7/vibeTerminal-Setup-0.1.7.exe) | Standard installer. Adds vibeTerminal to the Start Menu. |
