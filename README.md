...
| --- | --- | --- |
| Windows x64 | [LinaTerminal-Setup-0.1.117.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.117/LinaTerminal-Setup-0.1.117.exe) | Standard Windows installer. |
