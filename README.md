...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.8.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.8/vibeTerminal-Setup-0.1.8.exe) | Standard installer. Adds vibeTerminal to the Start Menu. |
