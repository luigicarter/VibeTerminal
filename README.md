...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.53.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.53/vibeTerminal-Setup-0.1.53.exe) | Standard Windows installer. |
