...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.41.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.41/vibeTerminal-Setup-0.1.41.exe) | Standard Windows installer. |
