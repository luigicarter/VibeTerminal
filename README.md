...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.97.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.97/vibeTerminal-Setup-0.1.97.exe) | Standard Windows installer. |
