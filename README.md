...
| --- | --- | --- |
| Windows x64 | [vibeTerminal-Setup-0.1.76.exe](https://github.com/luigicarter/VibeTerminal/releases/download/v0.1.76/vibeTerminal-Setup-0.1.76.exe) | Standard Windows installer. |
